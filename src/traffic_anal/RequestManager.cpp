...
namespace traffic_anal {
    FlowSegmentData RequestManager::parseSegmentData(const std::string& json_str) {
        ...
        try {
            ...
            auto data = json::value_to<FlowSegmentData>(flow_data);
    ...
    FlowSegmentData RequestManager::getSegmentData(double lat, double lon) const {
